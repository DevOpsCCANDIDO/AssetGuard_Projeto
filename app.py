    ...
    # --- ABA: CADASTRO (US02, US03 e US07) ---
        ...
        with st.form("asset_form"):
            ...
            if submitted:
                ...
                data_service.save_data(data=current_data, user=st.session_state.user_name, action="INSERT", message=f"Ativo {asset_name} adicionado com status {'VIOLAÇÃO' if not is_valid else 'APROVADO'}.")
